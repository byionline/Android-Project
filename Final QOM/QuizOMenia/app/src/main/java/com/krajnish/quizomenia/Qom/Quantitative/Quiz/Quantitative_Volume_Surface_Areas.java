...
public class Quantitative_Volume_Surface_Areas extends Fragment implements View.OnClickListener {

    public Quantitative_Volume_Surface_Areas(){
    ...
    private static class DBHelperpipes extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"volumeandsurfacearea\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "volumeandsurfacearea");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM volumeandsurfacearea WHERE DIFFICULTY=" + Difficulty +
