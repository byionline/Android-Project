...
public class Logical_Analyzing_Arguments extends Fragment  implements View.OnClickListener {

    public Logical_Analyzing_Arguments(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"logicalanalyzingarguments\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Incorrect4\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "logicalanalyzingarguments");
            onCreate(db);
        ...
        public List<Question1> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM logicalanalyzingarguments WHERE DIFFICULTY=" + Difficulty +
