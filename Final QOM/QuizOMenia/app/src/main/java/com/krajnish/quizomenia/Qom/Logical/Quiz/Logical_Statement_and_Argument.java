...
public class Logical_Statement_and_Argument extends Fragment  implements View.OnClickListener {

    public Logical_Statement_and_Argument(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
        "CREATE TABLE \"StatementandArgument\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Incorrect4\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "StatementandArgument");
            onCreate(db);
        ...
        public List<Question1> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM StatementandArgument WHERE DIFFICULTY=" + Difficulty +
