...
public class Technical_C_Language extends Fragment  implements View.OnClickListener {

    public Technical_C_Language(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"c_prog_que\" (\"Question\" Text DEFAULT (null) ,\"Answer\" Text DEFAULT (null) ,\"incorrect1\" Text DEFAULT (null) ,\"incorrect2\" Text DEFAULT (null) ,\"incorrect3\" Text DEFAULT (null) ,\"difficulty\" Integer DEFAULT (null) )");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "c_prog_que");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM c_prog_que WHERE DIFFICULTY=" + difficulty +
