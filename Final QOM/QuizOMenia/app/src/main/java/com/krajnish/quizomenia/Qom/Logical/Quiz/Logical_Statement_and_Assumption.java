...
public class Logical_Statement_and_Assumption extends Fragment  implements View.OnClickListener {

    public Logical_Statement_and_Assumption(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"statementandassumption\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Incorrect4\" TEXT, \"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "statementandassumption");
            onCreate(db);
        ...
        public List<Question1> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM logicalcauseandeffect WHERE DIFFICULTY=" + difficulty +
