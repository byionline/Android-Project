...
public class Selecting_Words extends Fragment  implements View.OnClickListener {

    public Selecting_Words(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"Selecting_Words\" (\"Question\" TEXT, \"Answer\" TEXT, \"incorrect1\" TEXT, \"incorrect2\" TEXT, \"incorrect3\" TEXT, \"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "Selecting_Words");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM Selecting_Words WHERE DIFFICULTY=" + difficulty +
