...
public class Spotting_Errors extends Fragment  implements View.OnClickListener {

    public Spotting_Errors(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"Spotting_Errors\" (\"Question\" TEXT, \"Answer\" TEXT, \"incorrect1\" TEXT, \"incorrect2\" TEXT, \"incorrect3\" TEXT, \"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "Spotting_Errors");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM Spotting_Errors WHERE DIFFICULTY=" + difficulty +
