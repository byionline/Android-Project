...
public class Change_of_voice extends Fragment  implements View.OnClickListener {

    public Change_of_voice(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"Change_Of_Voice\" (\"Question\" TEXT, \"Answer\" TEXT, \"incorrect1\" TEXT, \"incorrect2\" TEXT, \"incorrect3\" TEXT, \"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "Change_Of_Voice");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM Change_Of_Voice WHERE DIFFICULTY=" + difficulty +
