...
public class Logical_Number_Series extends Fragment  implements View.OnClickListener {

    public Logical_Number_Series(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"numberseries\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "numberseries");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM numberseries WHERE DIFFICULTY=" + Difficulty +
