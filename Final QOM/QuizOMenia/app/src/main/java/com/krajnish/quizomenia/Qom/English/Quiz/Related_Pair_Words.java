...
public class Related_Pair_Words extends Fragment  implements View.OnClickListener {

    public Related_Pair_Words(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"Related_Pair_Words\" (\"Question\" TEXT, \"Answer\" TEXT, \"incorrect1\" TEXT, \"incorrect2\" TEXT, \"incorrect3\" TEXT, \"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "Related_Pair_Words");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM Related_Pair_Words WHERE DIFFICULTY=" + difficulty +
