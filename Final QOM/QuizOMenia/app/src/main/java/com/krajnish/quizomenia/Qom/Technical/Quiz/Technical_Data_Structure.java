...
public class Technical_Data_Structure extends Fragment  implements View.OnClickListener {

    public Technical_Data_Structure(){
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /////////////////Quiz Menu////////////////////////////
        // getView(). This will return the root view for the fragment, with this we can call findViewById().
        /**
         *   Button starttest = (Button) getView().findViewById(R.id.btnStart);
         starttest.setOnClickListener(this);
         Button setting = (Button) getView().findViewById(R.id.btnSetting);
         setting.setOnClickListener(this);
         Button exit = (Button) getView().findViewById(R.id.btnExit);
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"DataStructure_prog_que\" (\"Question\" Text DEFAULT (null) ,\"Answer\" Text DEFAULT (null) ,\"incorrect1\" Text DEFAULT (null) ,\"incorrect2\" Text DEFAULT (null) ,\"incorrect3\" Text DEFAULT (null) ,\"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "DataStructure_prog_que");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM DataStructure_prog_que WHERE DIFFICULTY=" + difficulty +
