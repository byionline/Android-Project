...
public class Quantitative_Chain_Rule extends Fragment implements View.OnClickListener {

    public Quantitative_Chain_Rule(){
    ...
    private static class DBHelperpipes extends SQLiteOpenHelper {
     ...
     private boolean checkDataBase() {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
  "CREATE TABLE \"ChainRule\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "ChainRule");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM ChainRule WHERE DIFFICULTY=" + Difficulty +
