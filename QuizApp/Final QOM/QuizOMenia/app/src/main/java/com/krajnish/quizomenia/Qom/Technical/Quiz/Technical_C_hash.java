...
public class Technical_C_hash extends Fragment  implements View.OnClickListener {

    public Technical_C_hash(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
  " CREATE TABLE \"Chash_prog_que\" (\"Question\" TEXT DEFAULT (null) ,\"Answer\" TEXT DEFAULT (null) ,\"incorrect1\" TEXT DEFAULT (null) ,\"incorrect2\" TEXT DEFAULT (null) ,\"incorrect3\" TEXT DEFAULT (null) ,\"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "Chash_prog_que");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM Chash_prog_que WHERE DIFFICULTY=" + difficulty +
