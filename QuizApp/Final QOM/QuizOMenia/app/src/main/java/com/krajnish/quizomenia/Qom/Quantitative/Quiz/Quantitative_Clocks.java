...
public class Quantitative_Clocks extends Fragment implements View.OnClickListener {

    public Quantitative_Clocks(){
    ...
    private static class DBHelperpipes extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"clock\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public List<Question> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM clock WHERE DIFFICULTY=" + Difficulty +
