...
public class Antonyms extends Fragment  implements View.OnClickListener {
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"Antonyms\" (\"Question\" TEXT, \"Answer\" TEXT, \"incorrect1\" TEXT, \"incorrect2\" TEXT, \"incorrect3\" TEXT, \"difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "Antonyms");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM Antonyms WHERE DIFFICULTY=" + difficulty +
