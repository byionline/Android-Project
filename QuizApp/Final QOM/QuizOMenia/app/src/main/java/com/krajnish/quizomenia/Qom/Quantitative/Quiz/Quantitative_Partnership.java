...
public class Quantitative_Partnership extends Fragment implements View.OnClickListener {

    public Quantitative_Partnership(){
    ...
    private static class DBHelperpipes extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"partnership\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public List<Question> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM partnership WHERE DIFFICULTY=" + Difficulty +
