...
public class Quantitative_Percentage extends Fragment implements View.OnClickListener {

    public Quantitative_Percentage(){
    ...
    private static class DBHelperpipes extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"percentage\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficluty\" INTEGER)");
        }
        ...
        public List<Question> getQuestionSet(int Difficluty, int numQ) {
            List<Question> questionSet = new ArrayList<Question>();
            Cursor c = myDataBase.rawQuery("SELECT * FROM percentage WHERE DIFFICLUTY=" + Difficluty +
