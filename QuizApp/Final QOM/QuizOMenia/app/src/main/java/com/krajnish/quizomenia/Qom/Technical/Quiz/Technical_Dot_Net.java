...
public class Technical_Dot_Net extends Fragment  implements View.OnClickListener {

    public Technical_Dot_Net(){
 ...
 /*   private boolean checkDataBase(){
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"DotNet_prog_que\" (\"Question\" TEXT,\"Answer\" TEXT,\"incorrect1\" TEXT,\"incorrect2\" TEXT,\"incorrect3\" TEXT,\"difficulty\" Integer DEFAULT (null) )");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "DotNet_prog_que");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM DotNet_prog_que WHERE DIFFICULTY=" + difficulty +
