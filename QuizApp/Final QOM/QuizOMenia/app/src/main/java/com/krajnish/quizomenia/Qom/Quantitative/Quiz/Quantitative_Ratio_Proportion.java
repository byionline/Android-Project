...
public class Quantitative_Ratio_Proportion extends Fragment implements View.OnClickListener {

    public Quantitative_Ratio_Proportion(){
    ...
    private static class DBHelperpipes extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(
                    "CREATE TABLE \"ratioandproportion\" (\"Questions\" TEXT, \"Answers\" TEXT, \"Incorrect1\" TEXT, \"Incorrect2\" TEXT, \"Incorrect3\" TEXT, \"Difficulty\" INTEGER)");
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + "ratioandproportion");
            onCreate(db);
        ...
        public List<Question> getQuestionSet(int Difficulty, int numQ) {
            ...
            Cursor c = myDataBase.rawQuery("SELECT * FROM ratioandproportion WHERE DIFFICULTY=" + Difficulty +
